...
function calc_all_distances_dict(sim_param::SimParam, ss1::CatalogSummaryStatistics, ss2::CatalogSummaryStatistics; AD_mod::Bool=true)
    ...
    obs = ["periods", "period_ratios", "durations", "durations_norm_circ", "durations_norm_circ_singles", "durations_norm_circ_multis", "duration_ratios", "duration_ratios_nonmmr", "duration_ratios_mmr", "depths", "depths_above", "depths_below", "radii", "radii_delta_valley", "radius_ratios", "radius_ratios_above", "radius_ratios_below", "radius_ratios_across", "radii_partitioning", "radii_monotonicity", "gap_complexity"]
